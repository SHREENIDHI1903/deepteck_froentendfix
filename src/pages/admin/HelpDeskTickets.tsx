...
const getStatusBadge = (status: string) => {
    switch (status) {
        ...
        case 'closed':
            return <Badge className="bg-green-500"><CheckCircle2 className="w-3 h-3 mr-1 inline" />Closed</Badge>;
        default:
                                        ...
                                        <div className="border-t pt-6 pb-2">
                                            ...
                                            <div className="flex flex-col gap-6">
                                                ...
                                                {messages && messages.length > 0 && (
                                                    <div className="space-y-3 b-4">
                                                        <h5 className="text-sm font-semibold text-muted-foreground">Conversation History</h5>
                                                        <div className="space-y-2 max-h-[300px] overflow-y-auto pb-2">
                                                            {messages.map((msg) => (
                                                                <div
                                                                    key={msg.id}
                                                                    className={`p-3 rounded-lg ${msg.sender_type === 'admin'
                                                                        ? 'bg-blue-50 border border-blue-200 ml-8'
                                                                        : 'bg-green-50 border border-green-200 mr-8'
                                                                        }`}
                                                                >
                                                                    <div className="flex items-center gap-2 mb-1">
                                                                        <span className={`text-xs font-semibold ${msg.sender_type === 'admin' ? 'text-blue-700' : 'text-green-700'
                                                                            }`}>
                                                            ...
                                                            <AlertDialog open={showCloseConfirm} onOpenChange={setShowCloseConfirm}>
                                                                <AlertDialogContent>
                                                                    <AlertDialogHeader>
                                                                        ...
                                                                        <AlertDialogDescription>
                                                                            Are you sure you want to close this support ticket? This action will mark the ticket as resolved and prevent further replies.
                                                                        </AlertDialogDescription>
                                                                    </AlertDialogHeader>
                                                                    <AlertDialogFooter>
