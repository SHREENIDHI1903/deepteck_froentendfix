                                                                ...
                                                                <DialogContent className="sm:max-w-xl">
                                                                    ...
                                                                    <div className="grid gap-4 py-4">
                                                                        <div className="grid grid-cols-2 gap-4">
                                                                            <div>
                                                                                <div className="text-sm font-medium text-zinc-500 mb-1">User</div>
                                                                                <div className="text-sm">
                                                                                    {a.first_name} {a.last_name}
                                                                                    <div className="text-zinc-500 text-xs">{a.user_email}</div>
                                                                                </div>
                                                                            </div>
                                                                            <div>
                                                                                <div className="text-sm font-medium text-zinc-500 mb-1">Type</div>
                                                                                <div className="flex items-center gap-2 text-sm">
                                                                                    {typeIcons[a.detected_type]}
                                                                                    <span>{typeLabels[a.detected_type] || a.detected_type}</span>
                                                                                </div>
                                                                            </div>
                                                                            <div>
                                                                                <div className="text-sm font-medium text-zinc-500 mb-1">Action Taken</div>
                                                                                <Badge variant={a.action_taken === 'blocked' ? 'destructive' : 'secondary'}>
                                                                                    {a.action_taken || 'logged'}
                                                                                </Badge>
                                                                            </div>
                                                                            <div>
                                                                                <div className="text-sm font-medium text-zinc-500 mb-1">Detected Value</div>
                                                                                <code className="text-sm bg-zinc-100 px-1.5 py-0.5 rounded break-all">
                                                                                    {a.detected_value}
                                                                                </code>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div className="border-t pt-4">
                                                                            <div className="text-sm font-medium text-zinc-500 mb-2">Original Message Content</div>
                                                                            <div className="rounded-md border bg-zinc-50/50">
                                                                                <ScrollArea className="h-[200px] w-full p-4">
                                                                                    <p className="text-sm text-zinc-700 whitespace-pre-wrap leading-relaxed">
                                                                                        {a.original_content || "No content captured."}
                                                                                    </p>
                                                                                </ScrollArea>
                                                                            </div>
                                                                        </div>
