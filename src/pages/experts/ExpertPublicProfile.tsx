...
export default function ExpertPublicProfile() {
  ...
  const { data: rawExpert, isLoading, error } = useExpert(id!);
  ...
  // Check for 403 (Deactivated/Deleted) - Placed after hooks
      ...
      <Layout>
        <AlertDialog open={true}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogAction onClick={() => navigate('/experts')}>
                Back to Discovery
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
                      ...
                      <div className="space-y-1">
                        <div className="flex flex-col gap-1 items-start">
                          ...
                          <div className="flex flex-wrap items-center gap-2 mt-1 mb-1">
                            {/* Tier Badge */}
                            {expert_data.tier && expert_data.tier.tier_level && (
                              <div className={cn(
