  ...
  return (
    <Layout>
      <div className="min-h-screen bg-zinc-50/30">
        ...
        <div className="container max-w-full sm:max-w-3xl lg:max-w-7xl mx-auto py-4 sm:py-8 px-2 sm:px-6 lg:px-8">
      ...
      <ReportDialog
        ...
        reportedId={project.buyer_user_id || project.buyer?.user_id || project.buyer_id}
