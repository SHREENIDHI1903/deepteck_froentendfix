    ...
    return (
      ...
      */}
            ...
            <motion.div
                ...
                className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-blue-300/30 rounded-full blur-[100px]"
            />
            <motion.div
                animate={{
                    scale: [1, 1.3, 1],
                ...
                className="absolute bottom-[-20%] left-[20%] w-[700px] h-[700px] bg-indigo-300/20 rounded-full blur-[120px]"
            />
