    ...
    return (
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                <Button
                    className={cn(
                        // Responsive floating button: smaller and closer to edge on mobile
                        "fixed bottom-3 right-3 h-12 w-12 sm:bottom-6 sm:right-6 sm:h-14 sm:w-14 rounded-full shadow-2xl z-50 transition-all duration-300 hover:scale-110 hover:shadow-primary/25 flex items-center justify-center",
            ...
            <PopoverContent
                className="p-0 overflow-hidden shadow-2xl border-none rounded-2xl animate-in slide-in-from-bottom-5 fade-in-20 duration-300 w-[95vw] max-w-[380px] sm:w-[380px] mr-1 mb-2 sm:mr-6 sm:mb-4"
                align="end"
                side="top"
                sideOffset={12}
            >
                ...
                {/* Body Content */}
                <div className="bg-background min-h-[300px] max-h-[70vh] overflow-y-auto">
                    {view === "home" ? (
